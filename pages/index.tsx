      ...
      <header className="fixed top-0 inset-x-0 z-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <nav className="mt-4 flex items-center justify-between rounded-2xl bg-black/30 backdrop-blur-md border border-white/10 px-4 py-3">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm text-white/90">
              {[
                ...
                <a
                  key={l.id}
                  href={`#${l.id}`}
                  className="hover:text-[#69bdff] transition-colors"
                >
                  {l.t}
                </a>
              ))}
            ...
            <a
              href="#contact"
              className="rounded-xl bg-[#69bdff] px-4 py-2 text-sm font-semibold text-black hover:opacity-90 transition"
            >
              Get Started
            </a>
          </nav>
      ...
      >
        ...
        <section ref={heroRef} className="relative h-screen overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              ...
              WebkitMaskImage:
                "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.25) 40%, rgba(0,0,0,0.8) 70%, rgba(0,0,0,1) 100%)",
              maskImage:
                "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,0.25) 40%, rgba(0,0,0,0.8) 70%, rgba(0,0,0,1) 100%)",
              background:
                "linear-gradient(to bottom, rgba(62,78,94,0) 0%, rgba(62,78,94,0.2) 30%, rgba(40,48,59,0.6) 70%, rgba(40,48,59,1) 100%)",
            }}
          />
          ...
          <div className="relative z-10 flex h-full flex-col items-center justify-center text-center px-6">
            ...
            <motion.div className="mt-10 flex gap-4" {...fadeIn}>
              <a
                href="#hiretalent"
                className="rounded-xl bg-white text-blue-700 font-semibold py-2.5 px-6 hover:bg-gray-100 transition"
              >
                Find Talent
              </a>
              <a
        ...
        <section id="whysyfter" className="relative py-28">
          <div className="mx-auto max-w-6xl px-6">
            <motion.h2
              className="text-5xl font-bold mb-14 inline-block border-b-4 border-[#69bdff] pb-1"
              {...fadeIn}
            >
              Why Syfter
            </motion.h2>
              ...
              {[
                {
                  ...
                  body: "Screened for resilience, communication, and excellence.",
                },
                {
                  title: "AI-Proofed",
                  body: "Human-reviewed to avoid automation blind spots.",
                },
        ...
        <section id="trusted" ref={statsRef} className="py-24">
          <div className="mx-auto max-w-5xl px-6 text-center">
            <motion.h2
              className="text-5xl font-bold mb-12 underline decoration-[#69bdff]"
              {...fadeIn}
            >
              Trusted Results
            </motion.h2>
        ...
        <section id="syftercertify" className="py-24">
          <div className="mx-auto max-w-5xl px-6 text-center">
            <motion.h2
              className="text-4xl font-bold mb-8 inline-block border-b-4 border-[#69bdff] pb-1"
              {...fadeIn}
            >
              Syfter Certify
            </motion.h2>
        ...
        <section id="exec" className="py-24">
          <div className="mx-auto max-w-5xl px-6 text-center">
            <motion.h2
              className="text-5xl font-bold mb-14 underline decoration-[#69bdff]"
              {...fadeIn}
            >
              Executive Team
            </motion.h2>
        ...
        <section id="contact" className="py-24">
          <div className="mx-auto max-w-6xl px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-12">
            <div>
              ...
              <motion.p className="mb-6 text-lg" {...fadeIn}>
                Join hundreds of companies who trust Syfter to hire smarter, faster, and with clarity.
              </motion.p>
              <motion.p className="mb-4 text-md text-white/90" {...fadeIn}>
                New York, NY | Denver, CO | Remote Nationwide
              </motion.p>
              <a
                href="mailto:hello@syfter.com"
                className="inline-block rounded-xl bg-white text-blue-700 font-semibold py-3 px-6 hover:bg-gray-100 transition"
              >
                Contact Us
              </a>
            </div>
