...
<Head><title>Syfter — Precision Staffing Made Human</title></Head>
  {/* Navbar */}
  <header className="fixed top-0 w-full z-50 bg-[#2c3b4a]/90 shadow-sm py-4 px-6 flex justify-between items-center transition">
  ...
  <main className="pt-20 bg-gradient-to-b from-[#3e4e5e] via-[#1e3a5f] to-[#0b192f] text-white">
    ...
    {/* Why Syfter */}
    <motion.section id="whysyfter" className="pt-20 pb-10 bg-[#1e3a5f] text-center text-white" {...fadeInMotion}>
